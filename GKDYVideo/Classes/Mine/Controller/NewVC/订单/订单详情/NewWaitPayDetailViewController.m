//
//  NewWaitPayDetailViewController.m
//  GKDYVideo
//
...
@implementation NewWaitPayDetailViewController
...
//    view22.backgroundColor = [UIColor lightGrayColor];
   ...
   // UIView *view7 = [[UIView alloc]init];
    ...
    [button2 mas_makeConstraints:^(MASConstraintMaker *make) {
        make.right.equalTo(button1.mas_left).offset(-15);
        make.centerY.equalTo(bottomView.mas_centerY);
        make.size.mas_equalTo(CGSizeMake(80, 33));
    }];
    [button2 setTitle:@"取消订单" forState:UIControlStateNormal];
    [button2 setBackgroundColor:kWhiteColor];
    ...
    [button3 setTitle:@"修改地址" forState:UIControlStateNormal];
    [button3 setBackgroundColor:kWhiteColor];
