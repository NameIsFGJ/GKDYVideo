...
- (void)makeUI
{
    ...
    textField2.placeholder = @"请输入6-16位新密码";
    ...
    textField3.placeholder = @"请再次输入6-16位新密码";
    textField3.keyboardType = UIKeyboardTypeNamePhonePad;
    ...
    [submitButton mas_makeConstraints:^(MASConstraintMaker *make) {
        ...
        make.top.equalTo(view3.mas_bottom).offset(25);
