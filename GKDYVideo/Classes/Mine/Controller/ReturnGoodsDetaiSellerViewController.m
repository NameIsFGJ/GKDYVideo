//
//  ReturnGoodsDetaiSellerViewController.m
//  GKDYVideo
//
...
#import "ReturnGoodsDetaiSellerViewController.h"

@interface ReturnGoodsDetaiSellerViewController ()

@end

@implementation ReturnGoodsDetaiSellerViewController
...
- (void)makeUI
{
    ...
    returnTimeView.backgroundColor = [UIColor orangeColor];
    ...
    NSString *string  = @"1.如未发货,清点击同意退款给买家 \n2.如已发货,请主动和买家联系,确认后去订单上操作发货 \n3.逾期未处理,系统自动退款给买家";
    ...
    [reviseOrderButton setTitle:@"拒绝退款" forState:UIControlStateNormal];
    ...
    [backOrderButton setTitle:@"同意退款" forState:UIControlStateNormal];
