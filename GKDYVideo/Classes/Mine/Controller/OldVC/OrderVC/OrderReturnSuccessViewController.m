//
//  OrderReturnSuccessViewController.m
//  GKDYVideo
//
...
@interface OrderReturnSuccessViewController ()

@end

@implementation OrderReturnSuccessViewController
...
- (void)makeUI
{
    ...
    tipLabel3.text = @"该笔订单有199.99元退款,已原路返还";
