//
//  MarketSearchSaleViewController.m
//  GKDYVideo
//
...
@interface MarketSearchSaleViewController()<UICollectionViewDelegate,UICollectionViewDataSource,WSLWaterFlowLayoutDelegate>
...
@implementation MarketSearchSaleViewController
...
- (void)networking
{
    ...
    [MarketSearchGoodsNetworking postSearchGoodsWithKeyword:self.searchStr withPage:1 withSale:2 withPrice:1 complection:^(MarketUserShopModel * _Nonnull model, NSError * _Nonnull error) {
