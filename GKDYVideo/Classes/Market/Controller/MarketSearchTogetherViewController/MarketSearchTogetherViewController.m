//
//  MarketSearchTogetherViewController.m
//  GKDYVideo
//
...
@interface MarketSearchTogetherViewController ()<UICollectionViewDelegate,UICollectionViewDataSource,WSLWaterFlowLayoutDelegate>
@property (strong, nonatomic)UICollectionView *collectionView;
@property (strong, nonatomic)NSArray *itemsArray;
@property (strong, nonatomic)WSLWaterFlowLayout *flowLayout;
@end

@implementation MarketSearchTogetherViewController
...
- (void)networking
{
    ...
    [MarketSearchGoodsNetworking postSearchGoodsWithKeyword:self.searchStr withPage:1 withSale:1 withPrice:1 complection:^(MarketUserShopModel * _Nonnull model, NSError * _Nonnull error) {
